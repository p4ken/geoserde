...
impl Display for GeometryError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Source(_) => f.write_str("serialize impl for source type failed"),
        }
    }
}
...
impl serde::ser::Error for GeometryError {
